...
namespace Project.WebApplication.Areas.ProductManager.Controllers
{
    public class SystemCategoryAttributeController : BaseController
    {
        ...
        [HttpPost]
        public AbpJsonResult Add(AjaxRequest<SystemCategoryAttributeEntity> postData)
        {
        ...
        [HttpPost]
        public AbpJsonResult Edit( AjaxRequest<SystemCategoryAttributeEntity> postData)
        {
