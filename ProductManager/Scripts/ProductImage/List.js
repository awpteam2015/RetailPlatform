...
(function () {
    ...
    pro.ProductImage.ListPage = pro.ProductImage.ListPage || {};
    pro.ProductImage.ListPage = {
      init: function () {
            return {
        ...
        initPage: function () {
            ...
            gridObj.grid({
                url: '/ProductManager/ProductImage/GetList',
                fitColumns: false,
                nowrap: false,
                rownumbers: true, //行号
                singleSelect: true,
         ...
         { field: 'DeletionTime', title: '删除时间', width: 100 },
            ...
            $("#btnAdd").click(function () {
               tabObj.add("/ProductManager/ProductImage/Hd","新增");
            });
            ...
            $("#btnEdit").click(function () {
                ...
                tabObj.add("/ProductManager/ProductImage/Hd?PkId=" + PkId, "编辑" + PkId);
            });
            ...
            $("#btnDel").click(function () {
                ...
                $.messager.confirm("确认操作", "是否确认删除", function (bl) {
                    if (!bl) return;
                    abp.ajax({
                        url: "/ProductManager/ProductImage/Delete?PkId=" + gridObj.getSelectedRow().PkId
                    }).done(
...
$(function () {
    pro.ProductImage.ListPage.initPage();
});
