...
public  class Uploader
{
    ...
    public  Uploader()
    {
        uploadpath = @"\UploadFile\UeditorUP\";
        //switch (sitecode)
        //{
        //    case "HH":
        //        uploadpath = @"\UploadFile\UeditorUP\";
        //        break;
        //    case "TAO":
        //        uploadpath = @"\TAOUploadFile\UeditorUP\";
        //        break;
        //}
    }
  ...
  */
    public  Hashtable upFile(HttpContext cxt, string pathbase, string[] filetype, int size)
    {
        ...
        uploadpath = System.Web.HttpContext.Current.Server.MapPath(uploadpath + date+"\\");
        pathbase = pathbase;
        //uploadpath = cxt.Server.MapPath("/uploadfile/" + pathbase);//获取文件上传路径
