...
(function () {
    ...
    pro.UserInfo.ListPage = {
        ...
        initPage: function () {
            ...
            gridObj.grid({
                url: '/PermissionManager/UserInfo/GetList?UserCodes='+pro.commonKit.getUrlParam("UserCodes"),
                fitColumns: false,
                nowrap: false,
                rownumbers: true, //行号
                singleSelect: true,
         ...
         { field: 'LastModificationTime', title: '修改时间', width: 100 },
            ...
            $("#btnView").click(function () {
                ...
                var PkId = gridObj.getSelectedRow().PkId;
                var userName = gridObj.getSelectedRow().UserName;
                tabObj.add("/PermissionManager/UserInfo/ViewHd?PkId=" + PkId, "查看" + userName);
            });
