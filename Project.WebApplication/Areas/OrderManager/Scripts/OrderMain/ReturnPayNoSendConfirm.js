            ...
            addRule: function () {
                $("#form1").validate({
                    rules: {
                        ...
                        ReturnPayNoSendConfirmSerialNumber: { required: true }
      
                    },
                    messages: {
         
                        ReturnPayNoSendConfirmSerialNumber: "退款流水号必填!"
         
                    },
                    errorPlacement: function (error, element) {
                        pro.commonKit.errorPlacementReturnPayNoSendConfirm(error, element);
                    },
                    debug: false
                });
            },
