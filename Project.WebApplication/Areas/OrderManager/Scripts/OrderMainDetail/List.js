...
var pro = pro || {};
(function () {
    pro.OrderMainDetail = pro.OrderMainDetail || {};
    pro.OrderMainDetail.ListPage = pro.OrderMainDetail.ListPage || {};
    pro.OrderMainDetail.ListPage = {
      init: function () {
            return {
        ...
        initPage: function () {
            ...
            gridObj.grid({
                url: '/OrderManager/OrderMainDetail/GetList',
                fitColumns: false,
                nowrap: false,
                rownumbers: true, //行号
                singleSelect: true,
         ...
         { field: 'SpecName', title: '规格汇总', width: 100 },
            ...
            $("#btnAdd").click(function () {
               tabObj.add("/OrderManager/OrderMainDetail/Hd","新增");
            });
            ...
            $("#btnEdit").click(function () {
                ...
                tabObj.add("/OrderManager/OrderMainDetail/Hd?PkId=" + PkId, "编辑" + PkId);
            });
            ...
            $("#btnDel").click(function () {
                ...
                $.messager.confirm("确认操作", "是否确认删除", function (bl) {
                    if (!bl) return;
                    abp.ajax({
                        url: "/OrderManager/OrderMainDetail/Delete?PkId=" + gridObj.getSelectedRow().PkId
                    }).done(
...
$(function () {
    pro.OrderMainDetail.ListPage.initPage();
});
