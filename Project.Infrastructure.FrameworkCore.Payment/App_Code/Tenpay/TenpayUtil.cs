...
namespace tenpayApp
{
    ...
    public class TenpayUtil
    {
        ...
        static TenpayUtil()
        {
            ...
            bargainor_id = ConfigurationManager.AppSettings["TenpayPartner"];
            tenpay_key = ConfigurationManager.AppSettings["TenpayKey"];
            tenpay_return = ConfigurationManager.AppSettings["TenpayReturnUrl"];
            tenpay_notify = ConfigurationManager.AppSettings["TenpayNotifyUrl"];
